...
from apps.inline.images import ImageTabularInline
from apps.inline.product_attribute import ProductAttributeTranslatableTabularInline
from apps.models import Category, Product, User
from apps.models.shop import Banner, Attribute
# from apps.models.user import UserFlow
...
class BannerAdmin(admin.ModelAdmin):
    ...
    def picture(self, obj: Banner):
        return format_html(
            f'<img style="border-radius: 5px;" width="100px" height="30px" src="{obj.image.url}"/>')
...
# class UserFlowModelAdmin(admin.ModelAdmin):
#     list_display = list()
#
